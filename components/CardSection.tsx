...
import { FaBriefcase, FaUserShield, FaChartLine,   } from 'react-icons/fa'; 
import { AiFillReconciliation, AiTwotoneSliders, AiTwotoneWarning, AiFillWallet } from "react-icons/ai"
...
const cards: Card[] = [
  {
    icon: <AiFillReconciliation size={30} color="#4a90e2" />, // Example icon
    title: "IRS Audits",
  ...
  {
    icon: <AiTwotoneSliders size={30} color="#4a90e2" />,
  ...
  {
    icon: <AiFillWallet size={30} color="#4a90e2" />,
  ...
  {
    icon: <AiTwotoneWarning size={30} color="#4a90e2" />, // Example icon
